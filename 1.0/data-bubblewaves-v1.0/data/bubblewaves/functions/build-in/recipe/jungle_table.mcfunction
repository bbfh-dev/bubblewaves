...
execute if score %item0 bw.success matches 1 if score %item1 bw.success matches 3 run give @s item_frame{CustomModelData:1074, display:{Name:'{"translate":"bubblewaves.jungle_table", "italic":false}', Lore:['{"translate":"itemGroup.decorations", "color":"light_purple", "italic":false}']}, EntityTag:{Tags:["bubbleblock_placer", "table", "jungle"]}}