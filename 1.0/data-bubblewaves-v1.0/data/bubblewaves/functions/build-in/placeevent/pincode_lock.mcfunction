...
summon minecraft:armor_stand ~.5 ~ ~.5 {Tags:["bubbleblock", "bubbleproccess", "nohoppers", "pincode_lock", "solid", "preparing"], Small:1, NoBasePlate:1, Invisible:1, Marker:1, ArmorItems:[{}, {}, {}, {id:"minecraft:item_frame", Count:1b, tag:{CustomModelData:1030}}]}
...
setblock ~ ~ ~ barrel[facing=up]{CustomName:'{"translate":"bubblewaves.pincode_lock"}'}
