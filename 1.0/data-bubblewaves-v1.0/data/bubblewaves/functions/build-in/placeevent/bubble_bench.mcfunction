...
summon minecraft:armor_stand ~.5 ~ ~.5 {Tags:["bubbleblock", "bubbleproccess", "nohoppers", "bubble_bench", "solid", "preparing"], Small:1, NoBasePlate:1, Invisible:1, Marker:1, ArmorItems:[{}, {}, {}, {id:"minecraft:item_frame", Count:1b, tag:{CustomModelData:1000}}]}
...
setblock ~ ~ ~ barrel[facing=up]{CustomName:'{"translate":"bubblewaves.bubble_bench"}'}
